...
class UserShipmentData {
  ...
  String? status;
  String? statusName;
  List<DriverOrUserModel>? shipmentDriversRequests;
  ...
  factory UserShipmentData.fromJson(Map<String, dynamic> json) =>
      UserShipmentData(
        ...
        shipmentDriversRequests: json["shipment_drivers_requests"] == null
            ? []
            : List<DriverOrUserModel>.from(json["shipment_drivers_requests"]!
                .map((x) => DriverOrUserModel.fromJson(x))),
        shipmentLocations: json["shipment_locations"] == null
            ? []
            : List<ShipmentTracking>.from(json["shipment_locations"]!
                .map((x) => ShipmentTracking.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "shipment_drivers_requests": shipmentDriversRequests == null
            ? []
            : List<dynamic>.from(
                shipmentDriversRequests!.map((x) => x.toJson())),
