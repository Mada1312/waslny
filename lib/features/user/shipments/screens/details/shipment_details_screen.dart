...
class UserShipmentDetailsScreen extends StatefulWidget {
  const UserShipmentDetailsScreen({
    super.key,
    required this.args,
  });
...
class _UserShipmentDetailsScreenState extends State<UserShipmentDetailsScreen> {
        ...
        onWillPop: () async {
          if (widget.args.isFromNotification) {
            ...
            Navigator.pushNamedAndRemoveUntil(
                context, Routes.mainRoute, arguments: false, (route) => false);
          } else {
                  ...
                  : Column(
                      children: [
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          if (cubit.shipmentDetailsModel?.data
                                                  ?.status !=
                                              "0")
                                            Padding(
                                              padding:
                                          ...
                                          if (cubit.shipmentDetailsModel?.data
                                                  ?.status ==
                                              "0")
                                            buildCurrentDrivers(cubit,
                                                drivers: cubit
                                                    .shipmentDetailsModel
                                                    ?.data
                                                    ?.shipmentDriversRequests)
                                          else if (cubit.shipmentDetailsModel
                                                      ?.data?.status ==
                                                  "2" ||
                        ...
                        Padding(
                            ...
                            child: cubit.shipmentDetailsModel?.data?.status ==
                                    "0"
                                ? CustomButton(
                                ...
                                : cubit.shipmentDetailsModel?.data?.status ==
                                        "1"
                                    ? CustomButton(
                                        title: "loaded".tr(),
                                        onPressed: () {
        ...
        actions: cubit.shipmentDetailsModel?.data?.status == null
            ...
            : cubit.shipmentDetailsModel?.data?.status == "0"
                ? [
                    InkWell(
                      onTap: () {
                        Navigator.pushNamed(context, Routes.addNewShipmentRoute,
  ...
  Column buildCurrentDrivers(UserShipmentsCubit cubit,
      {List<DriverOrUserModel>? drivers}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          "suggested_drivers".tr(),
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          ...
                          shipmentId: cubit.shipmentDetailsModel?.data?.id
                                  ?.toString() ??
                              '',
                          hint: cubit.shipmentDetailsModel?.data
                                  ?.shipmentDateTimeDiff ??
                              "",
                        )),
                      ],
