...
//   static const String getproductsUrl = '${baseUrl}get-products?search=';
...
class EndPoints {
  ...
  // ✅ Map APIs
  static const String mapsBaseUrl = 'https://api.baraddy.com/api';
  static const String getAddressMapUrl = '$mapsBaseUrl/reverse';
  static const String searchOnMapUrl = '$mapsBaseUrl/search';
  static const String getRouteUrl = '$mapsBaseUrl/route';
  ...
  static const String getMyTrips = '${baseUrl}get-my-trips?filter_by=';
  static const String cancelTrip = '${baseUrl}cancel-trip';
  static const String saveDeviceTokenUrl = '${baseUrl}save-device-token';
}
